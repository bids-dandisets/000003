...
def _scrub_tsv_of_line_with_value(tsv_lines: list[str], identifying_value: str) -> list[str]:
    """
    ...
    """
    corrected_lines = [line for line in tsv_lines if identifying_value not in line]
